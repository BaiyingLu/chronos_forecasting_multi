...
# =====================================================
# BUILD TRAINING INPUTS (local CSVs)
# =====================================================
...
def main(args):
    ...
    for dataset_name, paths in datasets.items():
        ...
        print("\nBuilding full-shot training windows...")
        ...
        model_dir = Path(f"./chronos2_lora_fullshot_covariate_{dataset_name}")
        ...
        results_dir = Path(f"./results_covariate/{dataset_name}/fullshot")
